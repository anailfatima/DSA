...
public:
    ...
    void insertAtSpecific(int i, int val);
    int search(int val);
    void display();
    int deleteFromHead();
    int deleteFromTail();
...
void MyLL::insertAtTail(int val)
{
    Node *nn = new Node;
    nn->value = val;
    nn->next = nullptr;
...
void MyLL::insertAtHead(int val)
{
    Node *nn = new Node;
    nn->value = val;
    if (isEmpty())
...
void MyLL::insertAtSpecific(int i, int val)
{
